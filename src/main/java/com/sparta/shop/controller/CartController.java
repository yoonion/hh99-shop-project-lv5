...
public class CartController {
    ...
    @PostMapping
    public ApiResponse<CartAddResponseDto> addCart(
    ...
    @GetMapping
    public ApiResponse<CartInfoListResponseDto> getCartProducts(@AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ApiResponse<CartInfoResponseDto> updateCartQuantity(
    ...
    public ApiResponse<CartDeleteResponseDto> deleteCart(
            @PathVariable Long productId,
            @AuthenticationPrincipal UserDetailsImpl userDetails
    ) {
